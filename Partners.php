...
<a class="active">
			...
			<a href="register.php" style="color:#0074D9; margin-left: 200px; font-size: 15px; font-family: montserrat;">Client Portal</a>
...
<footer class="footer-distributed">
			...
			<div class="footer-left">
				...
				<p class="footer-company-name">Steve &copy; 2019</p>
